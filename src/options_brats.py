...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--crop_size', type=int, default=240, help='cropped image size for training')
    ...
    # training related
    self.parser.add_argument('--max_epochs', type=int, default=100, help='max training iterations')
